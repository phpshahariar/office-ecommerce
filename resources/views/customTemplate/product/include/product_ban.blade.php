    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 order-3">
                <div class="product_description">
                    ...
                    <h4>ডিল কোড : {{$product->id}}</h4>
                    {{--<h6>Uploaded by <i><a href="{{URL::to('/shopper-product/'.$shopper->id)}}">{{$shopper->user_name}}</a></i></h6>--}}

                    <div class="product_text text-justify"><p>{{$product->prodcut_short_description_ban}}</p></div>
                    <div class="order_info d-flex flex-row">
                        ...
                        <div class="product_category"> <span style="font-size: 20px; font-weight: 600" >৳ {{$product->product_price_ban}} </span> <strong> | </strong> {{ $product->note_ban}} </div><br/>
                        ...
                        <div class="button_container">
                            <button type="submit" name="btn" value="addToCart" class="button cart_button " style="font-size: 10px">কার্ট যোগ করুন</button>
                            <button type="submit" name="btn" value="orderNow" class="button cart_button " style="background-color: red; font-size: 10px">এখনি অর্ডার দিন</button>
                            <a href="{{URL::to('/cart')}}"  class="button cart_button" style="background-color: #0a8f08; font-size: 10px">কার্ট পেজ</a>
        ...
        <div class="row">
            <div class="col-lg-8 order-lg-2 order-1">
                <div class="card">
                    <div class="card-header"><h3>পণ্যের বিবরণ</h3></div>
            ...
            <div class="col-lg-4 order-lg-2 order-1">
                ...
                <div class="card">
                    <div class="card-header"><h4>সংশ্লিষ্ট পণ্য</h4></div>
                    <div class="card-body">
                        @foreach($reletedProducts as $reletedProduct)
                            <div class="row">
                                <div class="col-7">
                                    <h4>{{$reletedProduct->product_name_ban}}</h4>
                                    <h4>৳ {{$reletedProduct->product_price_ban}}</h4>
                                    <a href="{{URL::to('/product-view-by-id/'.$reletedProduct->id)}}"><button class="btn btn-info">কার্ট যোগ করুন</button></a>
                                </div>
