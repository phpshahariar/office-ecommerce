...
<div style="margin-left: 15px">
    ...
    <p style="font-size: 20px"><strong>{{$division->division_name.', '.$country->country_name}}</strong></p>
</div>
                ...
                <a href="{{URL::to('/product-view-by-id/'.$product->id)}}">
                    <div class="product_item is_new">
                        ...
                        <div class="product_content">
                            ...
                            <div class="product_name"><div><a href="{{URL::to('/product-view-by-id/'.$product->id)}}" tabindex="0">{{str_limit($product->product_name_eng, 20)}}</a></div></div>
