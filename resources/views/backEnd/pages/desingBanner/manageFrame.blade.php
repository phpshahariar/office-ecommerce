                    ...
                    <tr>
                        ...
                        <td style="text-align: center; width: auto" class="pmd-table-row-action">
                            @if(Session::get('admin_role') == 1)
                                ...
                                @endif
                            @endif
                            <button  data-target="#form-dialog-update-product{{$farme->id}}" data-toggle="modal" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm" type="button"> <i class="material-icons md-dark pmd-sm">edit</i></button>
                            <a onclick="return confirm('Are You Sure !!!. \n You Want To Deleted This Product')" href="{{URL::to('/delete-farme-by-id/'.$farme->id)}}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bordered">
                ...
                <h2 class="pmd-card-title-text">Frame Image</h2>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                <div class="pmd-card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="regular1" class="control-label">Status</label>
                                        <select class="custom-control" name="status">
